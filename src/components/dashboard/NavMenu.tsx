...
const NavMenu = () => {
  const menuList = [
    { name: 'Dashboard', icon: <Grid2x2 />, link: '/student' },
    { name: 'My Courses', icon: <BookText />, link: '/student/course' },
    ...
    { name: 'Resources', icon: <BookOpen />, link: '/student/resources' },
  ...
  return (
    <div className='bg-gray-900 h-screen px-4 text-white'>
